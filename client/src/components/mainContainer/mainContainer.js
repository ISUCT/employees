...
const users = [
  ...
  { fullname: 'Александр Беляев', location: '503 - Dream team', id: 2, in: true, skills: 'TypeScript Python NoSQL Java KVM C Redis MSSQL Hudson' },
  ...
  { fullname: 'Руслан Расулов', location: '511 - Bootcamp', id: 5, in: true, skills: 'Redis C# MSSQL RedHa Java PostgreSQL' },
  { fullname: 'Олег Косарев', location: '503 - Dream team', id: 6, in: true, skills: 'Bash MSSQL PostgreSQL Go Mercurial Docker Python JavaScript Hudson '},
  ...
  { fullname: 'Сммирнова Ольга', location: '102 - Home work', id: 10, in: false, skills: 'Go PostgreSQL Bash Hyper-V VirtualBox Java SVN'},
  { fullname: 'Константинов Евгений', location: '67 - Home work', id: 11, in: true, skills: 'Git Python Hudson SVN KVM SQL NoSQL MySQL'  }, 
  { fullname: 'Кузнецов Олег', location: '100 - Home work', id: 12, in: false, skills: 'VirtualBox PostgreSQL MSSQL Java SVN' },
  { fullname: 'Попов Илья', location: '67 - Home work', id: 13, in: false,  skills: 'NoSQL Gitlab JavaScript MSSQL Mercurial'},
  { fullname: 'Виктор Мурашов 2', location: '67 - Home work', id: 14, in: false, skills: 'NoSQL Python Docker KVM C# MSSQL Mercurial' },
  { fullname: 'Пронина Виктория', location: '67 - Home work', id: 15, in: false, skills: 'Hudson TypeScript Hyper-V' },
